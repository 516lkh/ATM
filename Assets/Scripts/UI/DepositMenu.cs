...
public class DepositMenu : View
{
    ...
    public override void Initialize()
    {
        ...
        _option1.onClick.AddListener(() => BankingManager.Instance.Deposit(BankingManager.Instance.atm.so_ATM.option1));
        _option2.onClick.AddListener(() => BankingManager.Instance.Deposit(BankingManager.Instance.atm.so_ATM.option2));
        _option3.onClick.AddListener(() => BankingManager.Instance.Deposit(BankingManager.Instance.atm.so_ATM.option3));
        _option4.onClick.AddListener(() => { BankingManager.Instance.Deposit(int.Parse(inputFigure.text)); inputFigure.text = ""; });
    }
}
